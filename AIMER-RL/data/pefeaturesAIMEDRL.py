...
class PEFeatureExtractor(object):
    ...
    def raw_features(self, bytez):
        lief_errors = (lief.lief_errors.file_format_error, lief.lief_errors.file_error, lief.lief_errors.build_error, lief.lief_errors.parsing_error, lief.lief_errors.read_out_of_bound,
                       RuntimeError)
        try:
